...
* [Real-time 2D Multi-Person Pose Estimation on CPU: Lightweight OpenPose](https://arxiv.org/pdf/1811.12004.pdf) - [\[CODE\]](https://github.com/Daniil-Osokin/lightweight-human-pose-estimation.pytorch) ⭐ 2,240 | 🐛 2 | 🌐 Python | 📅 2024-04-30 Osokin, D. (ArXiv 2018)
...
* [RMPE: Regional Multi-person Pose Estimation](https://arxiv.org/pdf/1612.00137.pdf) - [\[CODE1\]](https://github.com/Fang-Haoshu/RMPE) ⭐ 96 | 🐛 1 | 🌐 C++ | 📅 2018-09-01[\[CODE2\]](https://github.com/MVIG-SJTU/AlphaPose) ⭐ 8,599 | 🐛 304 | 🌐 Python | 📅 2024-05-13 - Fang, H., Xie, S., & Lu, C. (ICCV 2017)
...
* [Towards 3D Human Pose Estimation in the Wild: a Weakly-supervised Approach](https://arxiv.org/pdf/1704.02447.pdf) - [\[CODE\]](https://github.com/xingyizhou/Pytorch-pose-hg-3d) ⭐ 609 | 🐛 36 | 🌐 Python | 📅 2023-06-21 - Zhou, X., Huang, Q., Sun, X., Xue, X., & Wei, Y. (ICCV 2017)
...
* [pytorch-pose-hg-3d](https://github.com/xingyizhou/Pytorch-pose-hg-3d) ⭐ 609 | 🐛 36 | 🌐 Python | 📅 2023-06-21
